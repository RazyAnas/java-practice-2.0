...
abstract class Line implements Mappable {
    ...
    private String locations() {
        return  Arrays.deepToString(locations); // Arrays.deepToString() method in Java is used to get a string representation of the "deep contents" of an array, including the contents of nested arrays
    }
