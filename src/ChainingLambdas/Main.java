...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // and compose method --> opposite of and then method
        ...
        Function<String, String[]> f0 = uCase
                ...
                .andThen(s -> s.split(" ")); // only the last function in the chain needs to return a value that matches th declared return type specified by the function
        ...
        // Consumer --> Takes an input and does something with it (like printing), but does not return anything.
        ...
        // Predicate --> Takes an input and returns a boolean (true/false). Used mainly for filtering or conditions.
        ...
        Predicate<String> combined3 = p3.and(p4).negate(); // opposite result of combined2 test
